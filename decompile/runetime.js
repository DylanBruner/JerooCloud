!function (e) {
    ...
    function t() {
      for (var e, r = 0; r < u.length; r++) {
        for (var t = u[r], n = true, i = 1; i < t.length; i++) 0 !== o[t[i]] && (n = false);
    ...
    function a(r) {
      ...
      return e[r].call(t.exports, t, t.exports, a), t.l = true, t.exports;
    }
    a.e = function (e) {
      var r = [], t = o[e];
      if (0 !== t) if (t) r.push(t[2]); else {
        ...
        i.charset = "utf-8", i.timeout = 120, a.nc && i.setAttribute("nonce", a.nc), i.src = function (e) {
          return a.p + "" + ({}[e] || e) + "-es2015." + {5: "aa2e9b8489f5c9b779a8"}[e] + ".js";
        }(e);
        var c = new Error;
        u = function (r) {
      ...
      a.o(e, r) || Object.defineProperty(e, r, {enumerable: true, get: t});
    }, a.r = function (e) {
      ...
      if (a.r(t), Object.defineProperty(t, "default", {enumerable: true, value: e}), 2 & r && "string" != typeof e) for (var n in e) a.d(t, n, function (r) {
        return e[r];
      }.bind(null, n));
      return t;
    }, a.n = function (e) {
